(function () {
    ...
    var DEFAULTS = {
        title: "Excel Upload",
        subtitle: "Preview and upload Excel file",
        icon: "",
        unit: "",
    ...
    tmpl.innerHTML = `
        ...
        <div class="panel">
            <div class="header">
                ...
                <div class="subtitle">Configure preview, validation and continue-upload runtime flow</div>
            </div>
                ...
                <div class="layout">
                    <fieldset>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="field">
                                <input id="subtitle" name="subtitle" type="text" placeholder="Preview and upload Excel file">
                            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="field">
                                <input id="lastevent" name="lastevent" type="text" placeholder="previewCompleted / continueUpload / clear">
                            </div>
            ...
            <div class="help">
                SAC can set validationerrors after preview, then runtime highlights row/cell issues before final upload.
            </div>

            <div class="toolbar">
                <div class="chip-row">
                    <div class="chip">Preview first</div>
                    <div class="chip">Then continue upload</div>
                    <div class="chip">SAC final validation</div>
                </div>
                <div>
